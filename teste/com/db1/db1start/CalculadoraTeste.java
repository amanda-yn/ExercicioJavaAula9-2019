...
public class CalculadoraTeste {
	...
	@Test 
	public void deveRetornarNumeroPar() { 								//Testando se o numero e par
		int numeroPar = calculadora.numeroPar();
		Assert.assertEquals(20, numeroPar); 
	}
	
	@Test
	public void deveRetornarMaiorValor() { 								//Testando se o numero e maior que o outro numero
		int maiorValor = calculadora.maiorValor();
		Assert.assertEquals(20, maiorValor); 
	}
	
	@Test
	public void deveRetornarQuantidadeDeNumerosImpares() {				//Testando quantidade de numeros impares
		int quantidadeDeImpares = calculadora.quantidadeDeImpares();
		Assert.assertEquals(40, quantidadeDeImpares); 
	}
	
	@Test
	public void deveRetornarMenorValorEntreDoisValores() {				//Testando menor valor entre dois valores
		Double menorValor = calculadora.menorValorEntreDoisValores(25.5, 80.5);
		Assert.assertEquals(25.5, menorValor, 0.05); 
	}
	
	@Test
	public void deveRetornarMenorValorEntreTresValores() {				//Testando menor valor entre tres valores
	...
	@Test
	public void deveCalcularAreaDeUmTriangulo() { 						//Testando calculo da area de um triangulo
		Double area = calculadora.areaDeUmTriangulo(38.6, 50.8);
		Assert.assertEquals(980.44, area, 0.03); 
	}
}
